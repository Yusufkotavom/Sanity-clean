...
export default defineType({
  ...
  of: [
    ...
    defineArrayMember({ type: "hero-feature-card" }),
    defineArrayMember({ type: "section-header" }),
    defineArrayMember({ type: "split-row" }),
    defineArrayMember({ type: "split-content" }),
    defineArrayMember({ type: "split-cards-list" }),
    defineArrayMember({ type: "split-card" }),
    defineArrayMember({ type: "split-image" }),
    defineArrayMember({ type: "split-info-list" }),
    defineArrayMember({ type: "split-info" }),
    defineArrayMember({ type: "grid-card" }),
    defineArrayMember({ type: "pricing-card" }),
    defineArrayMember({ type: "grid-post" }),
    ...
    defineArrayMember({ type: "timelines-1" }),
    ...
    defineArrayMember({ type: "faq-block" }),
    ...
    defineArrayMember({ type: "value-props-block" }),
    defineArrayMember({ type: "stats-hero-block" }),
    defineArrayMember({ type: "eeat-block" }),
    defineArrayMember({ type: "metrics-rail-block" }),
    defineArrayMember({ type: "highlights-block" }),
    defineArrayMember({ type: "reviews-block" }),
    defineArrayMember({ type: "quote-spotlight-block" }),
    defineArrayMember({ type: "micro-badges-block" }),
    defineArrayMember({ type: "related-links-block" }),
    defineArrayMember({ type: "process-faq-block" }),
