import {
  ...
  useDispatch,
  useSelector
} from "./chunk-4FKZUPOU.js";
import {
  require_pluralize
} from "./chunk-DT34U3KS.js";
import {
  Box,
  Button,
  Card,
...
// ../node_modules/.pnpm/sanity-plugin-media@4.3.0_@emotion+is-prop-valid@1.4.0_@types+react@19.2.14_react-dom@1_a8c89dcc97238a537304fe4aaa29ebd0/node_modules/sanity-plugin-media/dist/index.mjs
...
var useVersionedClient = () => useClient({ apiVersion: "2025-10-02" });
...
var ToolOptionsProvider = ({ options: options2, children }) => {
  const value = (0, import_react17.useMemo)(() => {
    ...
    return options2?.creditLine?.excludeSources && (creditLineExcludeSources = Array.isArray(options2?.creditLine?.excludeSources) ? options2.creditLine.excludeSources : [options2?.creditLine?.excludeSources]), {
      ...
      createTagsOnUpload: options2?.createTagsOnUpload ?? true,
      creditLine: {
...
function localizedStringSchema(locales) {
  if (!locales || locales.length === 0)
    return stringType().trim().optional();
  const shape = {};
  for (const locale of locales)
    shape[locale.id] = stringType().trim().optional();
  return objectType(shape).passthrough();
}
...
function toStringField(value) {
  ...
  if (typeof value == "object" && value !== null)
    return Object.values(value).find((v3) => v3) || void 0;
}
function Details({
  formUpdating,
  handleCreateTag,
  ...
  const hasLocales = locales && locales.length > 0, [activeLocaleTab, setActiveLocaleTab] = (0, import_react17.useState)(0);
  return (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, children: [
    ...
    hasLocales ? (0, import_jsx_runtime3.jsx)(Card, { marginTop: 2, shadow: 1, padding: 3, radius: 1, children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 2, children: [
      (0, import_jsx_runtime3.jsx)(TabList, { space: 2, children: locales.map((locale, idx) => (0, import_jsx_runtime3.jsx)(
        Tab,
        {
      ...
      locales.map((locale, idx) => (0, import_jsx_runtime3.jsx)(
        TabPanel,
        {
          ...
          children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, children: [
            (0, import_jsx_runtime3.jsx)(
              FormFieldInputText,
              {
                ...
                disabled: formUpdating,
                error: errors2?.title?.[locale.id]?.message,
                label: "Title",
            ...
            (0, import_jsx_runtime3.jsx)(
              FormFieldInputText,
              {
                ...
                disabled: formUpdating,
                error: errors2?.altText?.[locale.id]?.message,
                label: "Alt Text",
            ...
            (0, import_jsx_runtime3.jsx)(
              FormFieldInputTextarea,
              {
                ...
                disabled: formUpdating,
                error: errors2?.description?.[locale.id]?.message,
                label: "Description",
            ...
            creditLine?.enabled && (0, import_jsx_runtime3.jsx)(
              FormFieldInputText,
              {
                ...
                error: errors2?.creditLine?.[locale.id]?.message,
                label: "Credit",
...
var DialogAssetEdit = (props) => {
  const {
    ...
    (asset) => {
      ...
      const flattenField = (field) => typeof field == "string" ? field : typeof field == "object" && field !== null && Object.values(field).find((v3) => v3) || "";
      return {
    ...
    mode: "onChange",
    resolver: t(getAssetFormSchema(locales))
  ...
  ), hasOrphanedLocales = (0, import_react17.useMemo)(() => {
    if (!currentAsset) return false;
    const isLocaleObj = (v3) => typeof v3 == "object" && v3 !== null && !Array.isArray(v3), fields = [
      currentAsset.title,
      currentAsset.altText,
      currentAsset.description,
      ...currentAsset._type === "sanity.imageAsset" ? [currentAsset.creditLine] : []
    ];
    if (!fields.some((f2) => isLocaleObj(f2))) return false;
    if (!locales || locales.length === 0) return true;
    const configuredIds = new Set(locales.map((l2) => l2.id));
    return fields.some((f2) => isLocaleObj(f2) ? Object.keys(f2).some((k2) => !configuredIds.has(k2)) : false);
  }, [currentAsset, locales]), handleCleanupLocales = (0, import_react17.useCallback)(async () => {
    if (!currentAsset) return;
    const cleanField = (field) => {
      if (typeof field != "object" || field === null || Array.isArray(field)) return field;
      const obj = field;
      if (!locales || locales.length === 0)
        return Object.keys(obj).sort().map((k2) => obj[k2]).find((v3) => v3) || "";
      const configuredIds = new Set(locales.map((l2) => l2.id)), cleaned = {};
  ...
  }, [client, currentAsset, locales]), onSubmit = (0, import_react17.useCallback)(
    (formData) => {
      if (!assetItem?.asset)
        return;
  ...
  const Footer = () => (0, import_jsx_runtime3.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, children: [
    hasOrphanedLocales && (0, import_jsx_runtime3.jsx)(Card, { padding: 3, radius: 2, shadow: 1, tone: "caution", children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", justify: "space-between", gap: 3, children: [
      (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: "This asset has localized fields that are no longer configured. Clean them up to avoid validation errors." }),
      (0, import_jsx_runtime3.jsx)(
        Button,
        {
          fontSize: 1,
    ...
    (0, import_jsx_runtime3.jsxs)(Flex, { justify: "space-between", children: [
      (0, import_jsx_runtime3.jsx)(
        Button,
        {
          disabled: formUpdating,
      ...
      (0, import_jsx_runtime3.jsx)(
        FormSubmitButton,
        {
          disabled: formUpdating || !isDirty2 || !isValid3 || hasOrphanedLocales,
          isValid: isValid3,
...
function getMediaTagNames(schemaType) {
  ...
  const unique = new Set(
    mediaTags.map((t3) => t3?.trim()).filter((t3) => !!t3?.length)
  );
...
function useBrowserInit(client, schemaType) {
  ...
  }, [client, dispatch, hasMediaTags]), (0, import_react17.useEffect)(() => {
...
var BrowserContent = ({
  ...
  const client = useVersionedClient(), [portalElement, setPortalElement] = (0, import_react17.useState)(null);
  return useBrowserInit(client, schemaType), (0, import_jsx_runtime3.jsx)(PortalProvider, { element: portalElement, children: (0, import_jsx_runtime3.jsxs)(UploadDropzone, { children: [
  ...
  return (0, import_jsx_runtime3.jsx)(
    ReduxProvider,
    {
      ...
      children: (0, import_jsx_runtime3.jsxs)(AssetBrowserDispatchProvider, { onSelect: props?.onSelect, children: [
        ...
        (0, import_jsx_runtime3.jsx)(BrowserContent, { onClose: props?.onClose, schemaType: props?.schemaType })
      ] })
    }
  );
};
var FormBuilderTool = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(PortalProvider, { element: portalElement, children: (0, import_jsx_runtime3.jsx)(Portal, { children: (0, import_jsx_runtime3.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime3.jsx)(Browser, { document: currentDocument, schemaType: props.schemaType, ...props })
    }
  ) }) });
};
...
var pendingByAsset = /* @__PURE__ */ new Map();
function applyMediaTags(options2) {
  const { assetId } = options2, chain = (pendingByAsset.get(assetId) ?? Promise.resolve()).then(
    () => doApplyMediaTags(options2)
  ), cleanup = chain.catch(() => {
  }).finally(() => {
...
function AutoTagInput(props) {
  const { renderDefault, schemaType, value, mediaTags: mediaTagsProp } = props, toast = useToast(), mediaTags = mediaTagsProp ?? schemaType?.options?.mediaTags, client = useVersionedClient(), { createTagsOnUpload } = useToolOptions(), prevAssetRef = (0, import_react17.useRef)(void 0), isInitialMount = (0, import_react17.useRef)(true), currentAssetRef = value?.asset?._ref;
  return (0, import_react17.useEffect)(() => {
    if (isInitialMount.current) {
      isInitialMount.current = false, prevAssetRef.current = currentAssetRef;
      return;
    }
...
function mediaField(config) {
  const { mediaTags, options: options2, components: components2, ...rest } = config;
  return {
    ...rest,
    options: { ...options2, mediaTags },
