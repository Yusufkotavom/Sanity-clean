...
const SAMPLE_TEMPLATE = {
  ...
  baseSections: ["hero", "highlights", "serviceTypes", "pricing", "process", "testimonials", "faq", "finalCta"],
  optionalSections: ["story"],
  ...
  sectionVariants: [
    {
      ...
      sectionType: "hero-1",
      copy: "Buka dengan manfaat komersial yang jelas, lalu dorong visitor langsung ke {{offer}}.",
      requiredTokens: ["primaryKeyword", "industry", "location", "offer"],
    },
    {
      ...
      colorVariant: "card",
      copy: "Sorot hasil, kejelasan proses, dan alasan memilih {{service}} tanpa copy yang terasa mass generated.",
      requiredTokens: ["service"],
    },
    {
      _key: "sample-story",
      key: "story",
      title: "Kenapa {{service}} ini perlu halaman yang terasa spesifik",
      sectionType: "split-row",
      colorVariant: "accent",
      copy: "Split row dipakai untuk menjelaskan konteks intent, diferensiasi, dan langkah berikutnya.",
      requiredTokens: ["service"],
      optional: true,
    },
    {
      _key: "sample-service-types",
      key: "serviceTypes",
      title: "Scope solusi {{service}}",
      sectionType: "service-types-block",
      colorVariant: "secondary",
      copy: "Tampilkan variasi penawaran inti, pendukung, dan jalur konsultasi agar sample terasa seperti landing page sungguhan.",
      requiredTokens: ["service"],
    },
    {
      _key: "sample-pricing",
      ...
      copy: "Pricing diposisikan sebagai alat framing scope, bukan tabel pasif.",
      requiredTokens: ["service"],
    },
    {
      _key: "sample-process",
      key: "process",
      title: "Alur kerja {{service}} dari brief ke output",
      sectionType: "timeline-row",
      colorVariant: "muted",
      copy: "Timeline membantu visitor memahami ritme kerja, feedback loop, dan ekspektasi hasil.",
      requiredTokens: ["service"],
    },
    {
      _key: "sample-testimonials",
      key: "testimonials",
      title: "Bukti sosial untuk {{industry}}",
      sectionType: "testimonials-block",
      colorVariant: "secondary",
      copy: "Gunakan proof untuk menyeimbangkan harga, proses, dan ajakan aksi.",
      requiredTokens: ["industry"],
    },
    {
      _key: "sample-faq",
      key: "faq",
      title: "Pertanyaan umum sebelum {{offer}}",
      sectionType: "faq-block",
      colorVariant: "background",
      copy: "FAQ menuntaskan keraguan akhir tanpa mengulang headline.",
    ...
    },
    {
      ...
      sectionType: "cta-1",
      colorVariant: "primary",
      copy: "Tutup dengan CTA yang jelas dan masih terasa satu bahasa desain dengan section sebelumnya.",
      requiredTokens: ["offer"],
    },
  ],
  status: "ready",
