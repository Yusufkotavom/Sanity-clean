...
const SERVICE_STARTERS = [
  {
    ...
    template: {
      ...
      baseSections: ["hero", "highlights", "serviceTypes"],
      optionalSections: ["pricing", "testimonials", "faq", "finalCta"],
      sectionVariants: [
        {
          _key: "website-hero",
          key: "hero",
        ...
        {
          _key: "website-highlights",
          key: "highlights",
          title: "Kenapa {{service}} ini relevan",
          sectionType: "value-props-block",
          copy: "Uraikan manfaat inti, pembeda visual, dan alasan halaman ini layak dipercaya untuk intent {{primaryKeyword}}.",
          requiredTokens: ["service", "primaryKeyword"],
        },
        {
          _key: "website-service-types",
          key: "serviceTypes",
          title: "Pilihan solusi {{service}}",
          sectionType: "service-types-block",
          copy: "Bentuk kartu layanan yang lebih visual agar visitor langsung melihat opsi utama dan opsi pendukung.",
          requiredTokens: ["service"],
        },
        {
          _key: "website-pricing",
          key: "pricing",
          title: "Pertimbangan investasi {{service}}",
          sectionType: "pricing-block",
          copy: "Gunakan section pricing sebagai anchor visual, bukan sekadar daftar harga datar.",
          requiredTokens: ["service"],
          optional: true,
        },
        {
          _key: "website-testimonials",
          key: "testimonials",
          title: "Apa kata klien {{service}}",
          sectionType: "testimonials-block",
          copy: "Taruh social proof setelah value dan service grid agar ritme visual halaman lebih meyakinkan.",
          requiredTokens: ["service"],
          optional: true,
        },
        {
        ...
        {
          _key: "website-final-cta",
          key: "finalCta",
          sectionType: "value-props-block",
          title: "Langkah berikutnya untuk {{location}}",
          copy: "Tutup halaman dengan section penutup yang tetap visual dan CTA {{offer}} yang konkret.",
  ...
  },
  {
    ...
    template: {
      ...
      baseSections: ["hero", "highlights", "serviceTypes"],
      optionalSections: ["testimonials", "faq", "finalCta"],
      sectionVariants: [
        {
          _key: "software-hero",
          key: "hero",
        ...
        {
          _key: "software-highlights",
          key: "highlights",
          title: "Hasil yang dicari sebelum membangun {{service}}",
          sectionType: "value-props-block",
          copy: "Tekankan outcome, integrasi, dan clarity agar ritme visual tidak jatuh menjadi paragraf panjang biasa.",
          requiredTokens: ["service"],
        },
        {
          _key: "software-service-types",
          key: "serviceTypes",
          title: "Ruang lingkup {{service}}",
          sectionType: "service-types-block",
          copy: "Pakai grid layanan agar penawaran software terasa modular, bukan abstrak.",
          requiredTokens: ["service"],
        },
        {
          _key: "software-testimonials",
          key: "testimonials",
          title: "Pembuktian untuk {{industry}}",
          sectionType: "testimonials-block",
          copy: "Social proof software harus muncul sebagai jeda visual sesudah service grid.",
        ...
        {
          _key: "software-final-cta",
          key: "finalCta",
          title: "Mulai evaluasi {{service}}",
          sectionType: "value-props-block",
          copy: "Tutup dengan CTA {{offer}} yang sesuai tahap bisnis, tetap ringkas, dan visual.",
  ...
  },
  {
    ...
    template: {
      ...
      sectionVariants: [
        ...
        {
          _key: "printing-highlights",
          key: "highlights",
          title: "Nilai utama {{service}}",
          sectionType: "value-props-block",
          copy: "Jelaskan kualitas, kecepatan, dan relevansi output untuk {{industry}} dalam bentuk value cards yang kuat.",
          requiredTokens: ["service", "industry"],
        },
        {
          _key: "printing-service-types",
          key: "serviceTypes",
          title: "Pilihan produksi {{service}}",
          sectionType: "service-types-block",
          copy: "Gunakan grid layanan agar family cetak terlihat kaya dan lebih visual seperti sample generator lama.",
          requiredTokens: ["service"],
        },
        {
        ...
        {
          _key: "printing-testimonials",
          key: "testimonials",
          title: "Kata pelanggan {{service}}",
          sectionType: "testimonials-block",
          copy: "Tambahkan lapisan trust visual sebelum FAQ dan CTA akhir.",
          requiredTokens: ["service"],
          optional: true,
        },
        {
        ...
        {
          _key: "printing-final-cta",
          key: "finalCta",
          title: "Lanjut ke {{offer}}",
          sectionType: "value-props-block",
          copy: "Akhiri dengan CTA yang membuat langkah berikutnya terasa ringan tapi tetap kuat secara visual.",
