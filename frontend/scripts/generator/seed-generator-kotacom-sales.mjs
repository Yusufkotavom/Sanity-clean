...
function template(cfg) {
  ...
  return {
    ...
    blocks: [
      ...
      { _type: "section-header", _key: `${id}-badges`, padding, colorVariant: "background", badges: [{ _key: `${id}-b1`, label: "Fast response", description: "Langsung arahkan inquiry ke WhatsApp" }, { _key: `${id}-b2`, label: "Scope jelas", description: "Harga dan timeline dibahas dari brief" }, { _key: `${id}-b3`, label: "Sales-ready", description: "Halaman dibuat untuk lead, bukan pajangan" }] },
